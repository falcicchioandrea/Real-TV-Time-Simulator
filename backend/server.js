...
const io = new Server(server, {   // Serve a creare un server WebSocket real-time con Socket.IO
    cors: {
        origin: "http://localhost:5173, https://real-tv-time-simulator.onrender.com",
        credentials: true
    }
});   
...
// di ricevere, leggere e visualizzare i dati elaborati dal server. 
    origin: ["http://localhost:5173", "http://localhost:5174", "https://real-tv-time-simulator.onrender.com"],
