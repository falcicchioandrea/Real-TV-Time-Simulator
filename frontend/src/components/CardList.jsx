...
const CardList = () => {
  ...
  const options = { // Opzioni per la richiesta fetch e gli headers
    method: "GET", 
    headers: {
  ...
  return (
    <div className="text-black md:px-4">
      <div>
        ...
        <Swiper slidesPerView="auto" spaceBetween={16}> {/* slidesPerView="auto" consente a Swiper di calcolare automaticamente il numero di slide da visualizzare in base alla larghezza del contenitore e alla larghezza di ogni slide. spaceBetween={16} aggiunge uno spazio di 16 pixel tra ogni slide, migliorando la leggibilità e l'estetica dello scorrimento. Queste opzioni insieme permettono di creare un layout fluido e adattabile per la visualizzazione dei film. */}
          {nowPlaying.map((item) => (
